...
class TodoApp(QWidget):
    class TodoApp(QWidget):
        latest_task_updated = pyqtSignal(str, str) 
    def __init__(self):
        super().__init__()
    ...
    def load_data(self):
        ...
        latest_in_progress = None  # Hier speichern wir den neuesten "In Progress"-Subtask
        ...
        if latest_in_progress:
            ...
            self.latest_task_updated.emit(latest_in_progress[0], latest_in_progress[1])  # Signal senden
        else:
